...
%time constraints from Holocene marine terrace, Owaka trench, and last interglacial terrace
time=vertcat([0,0],[3524,159],[19700,1900],[125000,7000]);
...
for hh=2:height(displacement) %Run loop for each displacement constraint
    ...
    while count<=target_simu 
        ...
        if disp_target(2)<=inc_sevd
            ...
            %Successively add displacement until dispacement exceeds dispacement marker max constraint
